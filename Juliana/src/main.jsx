...
import Ejercicio14 from './pages/Ejercicio14.jsx'
  ...
  <React.StrictMode>
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route exact path='/Ejercicio3' element={<Ejercicio3 message={'my friend!'}/>}></Route>
        ...
        <Route exact path='/Ejercicio14' element={<Ejercicio14/>}></Route>
      </Routes>
      <Footer/>
    </BrowserRouter>
  </React.StrictMode>,
